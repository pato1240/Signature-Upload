		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#comlogaligroupemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlogaligroupemployees-display": {
								"semanticObject": "comlogaligroupemployees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.logaligroup.employees",
									"url": sap.ui.require.toUrl("com/logaligroup/employees")
								}
							}
						}
					}
